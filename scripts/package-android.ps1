...
$androidMain = Join-Path $root 'apps/desktop/src-tauri/gen/android/app/src/main'
$assetsRoot = Join-Path $androidMain 'assets/inertia'
$jniLibs = Join-Path $androidMain 'jniLibs/arm64-v8a'
...
Write-Host "Next: npm run android:build (or android:run)"
