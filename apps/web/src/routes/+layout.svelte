  ...
  <div class="nav-actions">
    ...
    {#if identityState.identity}
      ...
      <a href="/profile" class="nav-profile" aria-label="Your profile">
        ...
        <span class="nav-profile-status">

          <StatusDot online={identityState.apiOnline} loading={identityState.loading} size={9} showLabel />
    ...
    {:else}
      ...
      <span class="nav-status-only" title="API connection status">
        ...
        <StatusDot online={identityState.apiOnline} loading={identityState.loading} size={10} showLabel />
